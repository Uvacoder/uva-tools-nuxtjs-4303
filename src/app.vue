    ...
    <div className="flex flex-col scroll-smooth">
        ...
        <div class="my-0 flex-1 mx-auto w-fit">
            <div class="mx-4 px-2 w-full max-w-4xl">
                ...
                <div class="flex gap-4 flex-wrap place-content-evenly justify-between">
                    <a
                    ...
                    >
                        <img
                            v-bind:src="tool.image"
                            v-bind:alt="tool.name"
        ...
        <footer class="w-screen bg-white dark:bg-gray-800">
        ...
        <img src="https://firebasestorage.googleapis.com/v0/b/tocinocode.appspot.com/o/global%2Flogo%20tocinocode.png?alt=media&token=45649449-37c5-4d26-91d0-4cb72359a439" class="mr-3 h-6 sm:h-9" alt="Tocinocode Logo">Tocinocode </a>
        <span class="block text-center text-sm text-gray-500 dark:text-gray-400">©2022 Tocinocode™. All Rights Reserved. Built with 
        <a target="_blank" class="text-rose-600 hover:underline dark:text-rose-500">Tailwind CSS</a>. 
        </span>      
        <ul class="mt-5 flex justify-center space-x-5">        
        <li>          
        <a class="text-rose-500 hover:text-rose-600 dark:text-rose-400 dark:hover:text-white">            
